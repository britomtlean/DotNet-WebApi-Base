...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:5028", "http://localhost:5173", "http://localhost:5174", "https://delivery-vite-production.up.railway.app") // Origem que você quer permitir
