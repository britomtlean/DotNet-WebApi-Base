...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:5028", "http://localhost:5173", "http://localhost:5174", "https://delivery-vite-production.up.railway.app", "https://colonia-menu-production.up.railway.app", "http://localhost:3000") // Origem que você quer permitir
